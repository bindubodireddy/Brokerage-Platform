...
function ProductPage() {
    return ( 
        <div>
            ...
            <LeftSection imageURL="media/images/varsity.png" productName="Varsity mobile"productDescription="An easy to grasp, collection of stock market lessons with in-depth coverage and illustrations. Content is broken down into bite-size cards to help you learn on the go."googlePlay="media/images/googlePlayBadge.svg" appStore="media/images/appstoreBadge.svg" />
            <p className='text-center fs-5'>Want to know more about our technology stack? Check out the <a href="#" className='tex-decoration-none'>Zerodha.tech</a> blog.</p>
            <Universe/>
        </div>        
     );
}
