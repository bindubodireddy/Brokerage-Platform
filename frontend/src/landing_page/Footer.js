...
function Footer() {
  return (
    <div className="container border-top">
      ...
      <div className="row mt-5 text-muted" style={{fontSize:"0.75rem"}}>
        <p className="pt-4">
      ...
      <div className=" d-flex flex-wrap justify-content-center gap-3 m-3">
        ...
        <a href="#" className="text-decoration-none text-muted">MCX Terms & conditions </a>
        ...
        <a href="#" className="text-decoration-none text-muted">policy Disclosure </a>
